...
|                        | Mon                                                                   | Tue                                                                                              | Wed                                                                  | Thu                                                                          | Fri                                               |
| ---------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------- |
| **Lecture**            | - Implementing a Test Strategy <br> - The Commit Stage <br> - Jenkins | - TDD Demo <br> - Game intro | - Automated Acceptance Testing<br>                                   | - Testing Nonfunctional Requirements <br> | No lecture, Lab day                               |
| **Reading Assignment** | Chapter 4,7                                                           |                                                                                                  | Chapter 8                                                            | Chapter 9                                                                    |                                                   |
| **Lab exercise**       | [Jenkins](/assignments/day06/README.md)                                | - [Game service](/assignments/day07/README.md)                                                    | - [Implement Game Logic and Unit Tests](/assignments/day08/README.md) | - [Acceptance Tests and more Jenkins targets](/assignments/day09/README.md)   | [Week 2 assignment](/assignments/day010/README.md) |
...
| **Lab exercise**       | [ Migrations and Capacity Tests](/assignments/day011/README.md) | [Connect UI](/assignments/day012/README.md)                           | - [Monitoring](/assignments/day013/README.md) <br> |                                   | [Week 3 assignment](A/assignments/day014/README.md) |
